...
tc_name = 'TC02_create_template_extract_onetime'
...
class TestExtract(unittest.TestCase):
    ...
    def test_create_template_extract_onetime(self):
        ...
        bc_extracts.pre_create_extract(TestResource.TestData.GlobalParameter.url,extracts_data.default_role)
        ...
        bc_extracts.create_extract_set_schedule_onetime(extracts_data.schedule_type,extracts_data.run_time_hour,extracts_data.run_time_min)
